...
import {SubBinService} from "./subbin.service";
...
@Component({
    selector: 'NgBin',
    templateUrl: 'subbin.component.html',
    providers: [SubBinService]
})
export class SubBinComponent implements OnInit {
    ...
    constructor(private service: SubBinService) {
