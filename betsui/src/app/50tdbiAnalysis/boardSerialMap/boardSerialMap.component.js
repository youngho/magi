...
var BoardSerialMapComponent = (function () {
    ...
    BoardSerialMapComponent.prototype.saveLastTableForm = function () {
        var _this = this;
    ...
    BoardSerialMapComponent.prototype.ngOnInit = function () {
    };
    BoardSerialMapComponent = __decorate([
        fade_in_top_decorator_1.FadeInTop(),
        core_1.Component({
            selector: 'SingledDutBin',
            templateUrl: 'boardSerialMap.component.html',
            providers: [boardSerialMap_service_1.BoardSerialMapService]
        })
    ], BoardSerialMapComponent);
    return BoardSerialMapComponent;
}());
exports.BoardSerialMapComponent = BoardSerialMapComponent;
