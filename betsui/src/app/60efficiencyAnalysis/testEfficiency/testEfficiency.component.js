...
var testEfficiency_service_1 = require("./testEfficiency.service");
var datatable_component_1 = require('./datatable.component');
var testEfficiency_model_1 = require('./testEfficiency.model');
var ProgramRevisionComponent = (function () {
    function ProgramRevisionComponent(service) {
        this.service = service;
        this.componentData = null;
        this.errorMessage = null;
        this.data = new testEfficiency_model_1.ProgramRevision();
    ...
    ProgramRevisionComponent = __decorate([
        ...
        core_1.Component({
            ...
            providers: [testEfficiency_service_1.ProgramRevisionService, testEfficiency_model_1.ProgramRevision]
        })
