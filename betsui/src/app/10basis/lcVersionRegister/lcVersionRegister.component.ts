...
export class LcVersionRegisterComponent implements OnInit {
    ...
    constructor(private programRegisterService: LcVersionRegisterService, private notificationService: NotificationService, private programRegister:LcVersionRegister) {
    }
    ...
    resetForm(){
        this.programRegister = new LcVersionRegister();  //이 클래스가 INPUT박스와 바인딩되어 있어 초기화 한다.
    }
