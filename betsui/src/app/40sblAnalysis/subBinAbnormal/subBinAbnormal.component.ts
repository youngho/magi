...
import {SubBinAbnormalService} from "./subBinAbnormal.service";
...
@FadeInTop()
@Component({
    selector: 'SubBinAbnormal',
    templateUrl: 'subBinAbnormal.component.html',
    providers: [SubBinAbnormalService]
})
export class SubBinAbnormalComponent implements OnInit {
    ...
    constructor(private service: SubBinAbnormalService) {
