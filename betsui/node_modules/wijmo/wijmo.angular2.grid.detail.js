...
{
"use strict";
var wjFlexGridDetail_outputs=['initialized', ],
...
return __extends(WjFlexGridDetail, _super), WjFlexGridDetail.prototype.ngOnInit = function()
{
...
}, WjFlexGridDetail._viewRefProp = '__wj_viewRef', WjFlexGridDetail.meta = {outputs: wjFlexGridDetail_outputs}, WjFlexGridDetail.decorators = [{
type: core_2.Directive, args: [{
selector: '[wjFlexGridDetail]', inputs: ['wjFlexGridDetail', 'maxHeight', 'detailVisibilityMode', 'rowHasDetail', 'isAnimated', ], outputs: wjFlexGridDetail_outputs, exportAs: 'wjFlexGridDetail', providers: [{
