...
public class DataSummaryController {
    ...
    public ResponseEntity<List<DataSummaryResultDto>> retrieveDataSummary(@RequestBody DataSummaryDto dataSummaryDto) {
        return new ResponseEntity<List<DataSummaryResultDto>>(dataSummaryService.retrieveDataSummary(dataSummaryDto), HttpStatus.OK);
    }
